...
\begin{enumerate}
    \item \textbf{Código entregable:} librería o configuración TypeScript/JavaScript que simule \texttt{@capacitor/geolocation}, \texttt{@capacitor/camera} y \texttt{@capacitor/preferences} con respuestas parametrizables, más integración ejemplificada en el proyecto Ionic de referencia.

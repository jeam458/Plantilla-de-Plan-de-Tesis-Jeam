...
%\usepackage{breakcites}  % requiere instalación: tlmgr install breakcites
...
% Código inline con cortes en /, ., -, _ (evita overfull hbox en PDF)
\urlstyle{tt}
...
%\usepackage{mathrsfs}  % requiere fuentes rsfs; descomentar si usa \mathscr (tlmgr install rsfs)
...
% Ajuste de estilo para alinearse al formato DAII:
% sin cabeceras/pies decorados ni líneas horizontales.
\pagestyle{plain}
\fancyhf{}

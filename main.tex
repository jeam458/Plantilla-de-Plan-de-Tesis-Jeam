...
\title{``Simulación de {APIs} nativas de {Capacitor} para pruebas unitarias, optimización de cobertura de código y orquestación auxiliar mediante {MCP} en aplicaciones {Ionic}"}

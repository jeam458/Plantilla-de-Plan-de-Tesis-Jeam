...
%\input{colors.tex}
%\usepackage{dsfont}  % no instalado en BasicTeX; descomentar si se usa \mathds
\usepackage{gantt}
%\usepackage[ruled,vlined]{algorithm2e}  % instalar: tlmgr install algorithm2e

\newtheorem{defn}{Definition}[section]
\pagenumbering{Roman}

\title{``Desarrollar y evaluar un módulo de simulación de {APIs} nativas de {Capacitor} para mejorar pruebas unitarias y cobertura de código, con orquestación auxiliar mediante {MCP} en aplicaciones {Ionic}"}
\author{Br. Jean Carlo Cuellar Vizcarra}
\orientador{Ing. Vanessa Choque}
\coorientador{---} % Co-asesor: sustituir por nombre o dejar guiones si no aplica
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{contenido/introduccion} %Introducción (línea de la investigación)
